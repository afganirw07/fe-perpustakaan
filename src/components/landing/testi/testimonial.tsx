...
const testimonials = [
    ...
    },
    {
        ...
        designation: "Guru Sejarah",
        company: "SMA Negeri 5 Jakarta",
        testimonial:
            "Saya sering menggunakan fasilitas ruang diskusi untuk mengajar di luar kelas. Lingkungannya nyaman, koneksi internetnya cepat, dan mendukung penuh kegiatan literasi.",
        avatar: "https://derapguru.com/wp-content/uploads/2024/09/Screenshot_20240913-192815_CS-PDF.jpg",
    },
    {
        id: 3,
        name: "Citra Dewi",
        designation: "Penulis Lepas",
        company: "Komunitas Literasi Online",
        testimonial:
            "Fitur peminjaman buku online sangat efisien! Saya tidak perlu antre panjang dan bisa memesan buku dari rumah. Ini menghemat waktu dan mendorong saya untuk lebih banyak membaca.",
        avatar: "https://images.genpi.co/uploads/arsip/normal/2022/08/05/mahasiswi-indonesia-usia-25-tahun-raih-gelar-dokto-eryb.jpg",
    },
    {
        id: 4,
        name: "Reza Firmansyah",
        designation: "Pustakawan Digital",
        company: "Pegiat Arsip Digital",
        testimonial:
            "Inisiatif digitalisasi koleksi patut diacungi jempol. Ini membuka akses pengetahuan bagi seluruh masyarakat Indonesia, tidak terbatas oleh lokasi fisik.",
        avatar: "https://instiki.ac.id/wp-content/uploads/2023/07/Bangga-Mahasiswa-INSTIKI-Jadi-Lulusan-Terbaik-20-Tim-Terbaik-dalam-Bangkit-2023-se-Indonesia.jpg",
    },
    {
        id: 5,
        name: "Siti Aisyah",
                    ...
                    {Array.from({ length: count }).map((_, index) => (
                        <button
                            ...
                            className={cn("h-3.5 w-3.5 rounded-full border-2", {
                                "bg-[hsl(0_0%_9%)] border-[hsl(0_0%_9%)]": current === index + 1,
                            })}
                        />
                    ))}
                </div>
...
const TestimonialCard = ({
    ...
    <div className="mb-8 bg-[hsl(0_0%_45.1%/0.08)] rounded-xl py-8 px-6 sm:py-6">
        <div className="flex items-center justify-between gap-20">
            <div className="hidden lg:block relative shrink-0 aspect-3/4 max-w-[18rem] w-full bg-muted-foreground/20 rounded-xl">
                ...
                <div className="absolute top-1/4 right-0 translate-x-1/2 h-12 w-12 bg-[hsl(0_0%_9%)]  rounded-full flex items-center justify-center">
                    <svg
                        width="102"
                        height="102"
                        viewBox="0 0 102 102"
                ...
                <div className="flex items-center justify-between gap-1">
                    <div className="hidden sm:flex md:hidden items-center gap-4">
                        <Avatar className="w-8 h-8 md:w-10 md:h-10">
                            <AvatarFallback className="text-xl font-medium bg-[hsl(0_0%_9%)] text-[hsl(0_0%_98%)]">
                    ...
                    <div className="flex items-center gap-1">
                        <StarIcon className="w-5 h-5 fill-[#FFC107] stroke-[#FFC107]" />
                        <StarIcon className="w-5 h-5 fill-[#FFC107] stroke-[#FFC107]" />
                        <StarIcon className="w-5 h-5 fill-[#FFC107] stroke-[#FFC107]" />
                        <StarIcon className="w-5 h-5 fill-[#FFC107] stroke-[#FFC107]" />
                        <StarIcon className="w-5 h-5 fill-[#FFC107] stroke-[#FFC107]" />
